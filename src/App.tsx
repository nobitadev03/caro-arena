...
export default function App() {
  ...
  // Center the board on load
  useEffect(() => {
    if (roomId && boardRef.current) {
  ...
  return (
    <>
      ...
      {/* Game Board */}
      <main className="flex-1 overflow-hidden relative bg-slate-200/50">
        <div 
          ref={boardRef}
          className="absolute inset-0 overflow-auto p-2 sm:p-4 md:p-8"
        >
          <div className="inline-block bg-white shadow-xl rounded-xl p-1 sm:p-2 md:p-4 min-w-max mx-auto">
            <div 
              className="grid gap-0 border border-slate-300 bg-slate-300"
              style={{ 
                ...
                row.map((cell, colIndex) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-white border border-slate-200 flex items-center justify-center text-xl sm:text-2xl transition-all",
